...
namespace GenFx
{
    ...
    public abstract class ComponentFactoryConfig<TConfiguration, TComponent> : IComponentFactoryConfig, INotifyPropertyChanged
        ...
        where TComponent : GeneticComponent<TComponent, TConfiguration>
    {
        ...
        public void Validate()
        {
            IEnumerable<PropertyInfo> properties = this.GetType()
                ...
                .Where(p => p.DeclaringType != typeof(ComponentFactoryConfig<TConfiguration, TComponent>));
