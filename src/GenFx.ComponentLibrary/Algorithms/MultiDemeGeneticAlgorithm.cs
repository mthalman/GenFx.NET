...
namespace GenFx.ComponentLibrary.Algorithms
{
    ...
    public class MultiDemeGeneticAlgorithm : SimpleGeneticAlgorithm
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="MultiDemeGeneticAlgorithm"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the value indicating how many <see cref="GeneticEntity"/> objects are migrated between
        ...
        public int MigrantCount
        {
            get
            {
                ...
                return ((MultiDemeGeneticAlgorithmConfiguration)this.ConfigurationSet.GeneticAlgorithm).MigrantCount;
            }
        }
        ...
        public int MigrateEachGeneration
        {
            get
            {
                ...
                return ((MultiDemeGeneticAlgorithmConfiguration)this.ConfigurationSet.GeneticAlgorithm).MigrateEachGeneration;
            }
        }
        ...
        protected virtual void OnMigrate()
        {
            ...
            for (int populationIndex = 1; populationIndex < populations.Count; populationIndex++)
            {
                ...
                List<GeneticEntity> sortedEntities = population.Entities.GetEntitiesSortedByFitness(
                    this.Operators.SelectionOperator.SelectionBasedOnFitnessType,
                    this.Operators.FitnessEvaluator.EvaluationMode).ToList();
    ...
    /// <summary>
    /// Represents the configuration of <see cref="MultiDemeGeneticAlgorithm"/>.
    /// </summary>
    [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Multi")]
    [Component(typeof(MultiDemeGeneticAlgorithm))]
    public class MultiDemeGeneticAlgorithmConfiguration : GeneticAlgorithmConfiguration
    {
        ...
        [DefaultValue(MultiDemeGeneticAlgorithmConfiguration.DefaultMigrantCount)]
        ...
        /// </summary>
        /// <exception cref="ValidationException">Value is not valid.</exception>
        [DefaultValue(MultiDemeGeneticAlgorithmConfiguration.DefaultMigrateEachGeneration)]
