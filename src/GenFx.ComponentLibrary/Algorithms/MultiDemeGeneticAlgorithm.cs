...
namespace GenFx.ComponentLibrary.Algorithms
{
    ...
    public sealed class MultiDemeGeneticAlgorithm : MultiDemeGeneticAlgorithm<MultiDemeGeneticAlgorithm, MultiDemeGeneticAlgorithmFactoryConfig>
    {
        /// <summary>
        /// Initializes a new instance of this class.
        /// </summary>
        /// <param name="configurationSet">Contains the component configuration for the algorithm.</param>
        public MultiDemeGeneticAlgorithm(ComponentFactoryConfigSet configurationSet)
