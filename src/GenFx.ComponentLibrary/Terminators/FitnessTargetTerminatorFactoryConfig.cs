...
namespace GenFx.ComponentLibrary.Terminators
{
    ...
    /// </summary>
    public sealed class FitnessTargetTerminatorFactoryConfig : TerminatorFactoryConfigBase<FitnessTargetTerminatorFactoryConfig, FitnessTargetTerminator>
    {
        private const FitnessType DefaultFitnessValueType = FitnessType.Scaled;

        private FitnessType fitnessValueType = FitnessTargetTerminatorFactoryConfig.DefaultFitnessValueType;
