...
namespace GenFx.ComponentLibrary.SelectionOperators
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FitnessProportionateSelectionOperator"/> class.
        /// </summary>
        /// <param name="algorithm"><see cref="GeneticAlgorithm"/> using this <see cref="FitnessProportionateSelectionOperator"/>.</param>
        /// <exception cref="ArgumentNullException"><paramref name="algorithm"/> is null.</exception>
        /// <exception cref="ValidationException">The component's configuration is in an invalid state.</exception>
        public FitnessProportionateSelectionOperator(GeneticAlgorithm algorithm)
            : base(algorithm)
        {
        }
        ...
        protected override GeneticEntity SelectEntityFromPopulation(Population population)
        {
            ...
            FitnessEvaluationMode evaluationMode = this.Algorithm.Operators.FitnessEvaluator.EvaluationMode;
    ...
    /// <summary>
    /// Represents the configuration of <see cref="FitnessProportionateSelectionOperator"/>.
    /// </summary>
    [Component(typeof(FitnessProportionateSelectionOperator))]
    public class FitnessProportionateSelectionOperatorConfiguration : SelectionOperatorConfiguration
    {
    }
}
