...
namespace GenFx.ComponentLibrary.Base
{
    ...
    public abstract class PopulationFactoryConfigBase<TConfiguration, TPopulation> : ConfigurationForComponentWithAlgorithm<TConfiguration, TPopulation>, IPopulationFactoryConfig
