...
namespace GenFx.ComponentLibrary.Base
{
    ...
    public abstract class MutationOperatorFactoryConfigBase<TConfiguration, TMutation> : ConfigurationForComponentWithAlgorithm<TConfiguration, TMutation>, IMutationOperatorFactoryConfig
