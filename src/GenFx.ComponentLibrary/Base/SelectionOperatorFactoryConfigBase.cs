...
namespace GenFx.ComponentLibrary.Base
{
    ...
    public abstract class SelectionOperatorFactoryConfigBase<TConfiguration, TSelection> : ConfigurationForComponentWithAlgorithm<TConfiguration, TSelection>, ISelectionOperatorFactoryConfig
