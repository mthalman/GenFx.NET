...
namespace GenFx.ComponentLibrary.Base
{
    ...
    public abstract class CrossoverOperatorFactoryConfigBase<TConfiguration, TCrossover> : ConfigurationForComponentWithAlgorithm<TConfiguration, TCrossover>, ICrossoverOperatorFactoryConfig
