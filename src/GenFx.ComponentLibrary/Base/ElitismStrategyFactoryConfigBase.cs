...
namespace GenFx.ComponentLibrary.Base
{
    ...
    public abstract class ElitismStrategyFactoryConfigBase<TConfiguration, TElitism> : ConfigurationForComponentWithAlgorithm<TConfiguration, TElitism>, IElitismStrategyFactoryConfig
