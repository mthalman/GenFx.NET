...
namespace GenFx.ComponentLibrary.Lists
{
    ...
    public abstract class IntegerListEntityFactoryConfig<TConfiguration, TEntity> : ListEntityFactoryConfig<TConfiguration, TEntity, int>, IIntegerListEntityFactoryConfig
