...
namespace GenFx.ComponentLibrary.Lists
{
    ...
    public sealed class VariableLengthIntegerListEntity : VariableLengthIntegerListEntity<VariableLengthIntegerListEntity, VariableLengthIntegerListEntityConfiguration>
    {
        /// <summary>
