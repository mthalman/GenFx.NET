namespace GenFx.ComponentLibrary.Trees
{
    ...
    public abstract class TreeEntityFactoryConfig<TConfiguration, TEntity, TNode> : TreeEntityFactoryConfig<TConfiguration, TEntity>
        where TConfiguration : TreeEntityFactoryConfig<TConfiguration, TEntity, TNode> 
