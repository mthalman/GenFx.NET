...
namespace GenFx.ComponentLibrary.Trees
{
    ...
    public abstract class SingleNodeTreeCrossoverOperatorFactoryConfig<TConfiguration, TCrossover> : CrossoverOperatorFactoryConfigBase<TConfiguration, TCrossover>
