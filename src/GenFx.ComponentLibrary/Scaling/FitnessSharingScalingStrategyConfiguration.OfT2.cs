...
namespace GenFx.ComponentLibrary.Scaling
{
    ...
    public abstract class FitnessSharingScalingStrategyConfiguration<TConfiguration, TScaling> : FitnessScalingStrategyConfigurationBase<TConfiguration, TScaling>
