...
namespace GenFx.ComponentLibrary.Scaling
{
    ...
    public abstract class FitnessSharingScalingStrategy : FitnessScalingStrategy
    {
        ...
        /// <summary>
        /// Gets the power to which the distance between two entities will be raised when calculating
        /// the scaled fitness value.
        /// </summary>
        /// <remarks>A value of 1 the curvature is a straight line.</remarks>
        public double ScalingCurvature
        {
            get { return ((FitnessSharingScalingStrategyConfiguration)this.Algorithm.ConfigurationSet.FitnessScalingStrategy).ScalingCurvature; }
        }

        /// <summary>
        /// Gets the cutoff value of the distance between two genetic entities that will result in the curvature being applied to those genetic entities.
        /// </summary>
        /// <remarks>
        ...
        {
            get { return ((FitnessSharingScalingStrategyConfiguration)this.Algorithm.ConfigurationSet.FitnessScalingStrategy).ScalingDistanceCutoff; }
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="FitnessSharingScalingStrategy"/> class.
        /// </summary>
        /// <param name="algorithm"><see cref="GeneticAlgorithm"/> using this <see cref="FitnessSharingScalingStrategy"/>.</param>
        /// <exception cref="ArgumentNullException"><paramref name="algorithm"/> is null.</exception>
        /// <exception cref="ValidationException">The component's configuration is in an invalid state.</exception>
        protected FitnessSharingScalingStrategy(GeneticAlgorithm algorithm)
            : base(algorithm)
        {
        }
        ...
        /// objects in <paramref name="population"/> according to the fitness sharing scaling algorithm.
        /// </summary>
    ...
    /// <summary>
    /// Represents the configuration of <see cref="FitnessSharingScalingStrategy"/>.
    /// </summary>
    [Component(typeof(FitnessSharingScalingStrategy))]
    public abstract class FitnessSharingScalingStrategyConfiguration : FitnessScalingStrategyConfiguration
    {
        private const double DefaultScalingCurvature = 1;
        private const double DefaultScalingDistanceCutoff = 1;

        private double scalingDistanceCutoff = FitnessSharingScalingStrategyConfiguration.DefaultScalingDistanceCutoff;
        private double scalingCurvature = FitnessSharingScalingStrategyConfiguration.DefaultScalingCurvature;
