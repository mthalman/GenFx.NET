...
{
    /// <summary>
    /// This is a test class for GenFx.Components.Terminators.GenerationalTerminator and is intended
    /// to contain all GenFx.Components.Terminators.GenerationalTerminator Unit Tests
    /// </summary>
