...
{
    /// <summary>
    ///This is a test class for GenFx.Components.Terminators.TimeDurationTerminator and is intended
    ///to contain all GenFx.Components.Terminators.TimeDurationTerminator Unit Tests
    ///</summary>
