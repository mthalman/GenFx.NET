...
{
    /// <summary>
    ///This is a test class for GenFx.Components.SelectionOperators.RankSelectionOperator and is intended
    ///to contain all GenFx.Components.SelectionOperators.RankSelectionOperator Unit Tests
    ///</summary>
