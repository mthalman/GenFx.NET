...
{
    /// <summary>
    /// This is a test class for GenFx.Components.Scaling.FitnessSharingScalingStrategy and is intended
    /// to contain all GenFx.Components.Scaling.FitnessSharingScalingStrategy Unit Tests
    /// </summary>
